...
#python /zhome/dd/4/109414/Validationstudy/slumbernet/train_slumbernet_v2.py --basedir /zhome/dd/4/109414/Validationstudy/slumbernet/config/slumbernet_labs.yml --test_lab "Antoine" --output_dir /work3/laurose/SlumberNet/models/fixed_n/Antoine/ 
python /zhome/dd/4/109414/Validationstudy/slumbernet/train_slumbernet_v2.py --basedir /zhome/dd/4/109414/Validationstudy/slumbernet/config/slumbernet_labs.yml --test_lab "Alessandro" --out_dir  /work3/laurose/SlumberNet/models/all_n/lab1/
